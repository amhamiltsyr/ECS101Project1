...
list4 = ['b','c','d','f','g','h','j','k','l','m','n','p','q','v','w','x','y','z'
...
# finds character value
# Takes in the binary representation and the corresponding dictionary
# returns the location of the character value in the dictionary
